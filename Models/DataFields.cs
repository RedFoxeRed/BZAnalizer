        ...
        public static Dictionary<string, List<string>> EnglishBlockParameters = new Dictionary<string, List<string>>()
        {
            ...
            },
            {
                ...
                new List<string>
                {
                    ...
                    "Потребляемая мощность (Вт) / Power Периметральный обогрев /",//"Потребляемая мощность (Вт)",
                    "Возвратная пружина / Return spring", //"Возвратная пружина",
                    "Мощность обогрева (Вт) / Heating's Напряжение обогрева (В) /",//"Мощность обогрева (Вт)",
                    "Обратная связь",
                    "Время поворота пружины (с)",
                    "Материал корпуса",
                    "Расположение привода",
